...
class Telemetry:
    ...
    def __init__(
        ...
        Args:
            ...
            options: Configuration options for telemetry setup
        """
        # Store basic service information
        self.service_name = name
        self.service_version = options.version
        self.environment = options.environment
        self.log_level = options.log_level
        self.use_json_logs = options.use_json_logs
        ...
        if options.resource_attributes:
            resource_attrs.update(options.resource_attributes)
